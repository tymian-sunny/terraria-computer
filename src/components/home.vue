<template>
    <div>
        ...
        <el-affix :offset="10">
            ...
            <div class="mb-2 ml-4">
                <el-radio-group v-model="worldType"
                    style="background-color: rgba(179, 237, 242, 0.9);padding: 0 2% 0 2%;border-radius: 15px;">
        ...
        <div>
            第一随机数:
            <el-input-number v-model="firstRandom" :min="0" :max="1" :step="0.01" size="right" controls-position="right"
                @change="countTheFirstRandom()" />
        </div>

        <div>
            第二随机数:
            <el-input-number v-model="secondRandom" :min="0" :max="1" :step="0.01" size="right"
                controls-position="right" @change="countTheSecondRandom()" />
        </div>
        <div>
            第三随机数:
            <el-input-number v-model="thirdRandom" :min="0" :max="1" :step="0.01" size="right" controls-position="right"
                @change="countTheThirdRandom()" />
        </div>
        <div>
            第九随机数:
            <el-input-number v-model="ninthRandom" :min="0" :max="1" :step="0.01" size="right" controls-position="right"
        ...
        <div id="box" style="position: relative; display: inline-block;">
            <!-- 背景图 -->
            <img id="bg" src="/dungeonBox/background.png" alt="" style="width: 400px; display: block;">
